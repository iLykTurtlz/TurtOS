...
#define MAKE_LIST(PREFIX, PTR_T)                                                                                   \
    ...
    {                                                                                                              \
        ...
        size_t len;                                                                                                \
                                                                                                                   ...
                                                                                                                   \
    void PREFIX##_list_init(struct PREFIX##_list *lst)                                                                    \
    {                                                                                                              \
        lst->head = KERNEL_NULL;                                                                                   \
        lst->len = 0;                                                                                              \
    }                                                                                                              \
                                                                                                                   \
    struct PREFIX##_list *PREFIX##_list_new(void)                                                                  \
    {                                                                                                              \
        struct PREFIX##_list *lst = (struct PREFIX##_list *)kmalloc(sizeof(struct PREFIX##_list));                 \
        lst->head = KERNEL_NULL;                                                                                   \
        lst->len = 0;                                                                                              \
        return lst;                                                                                                \
    }                                                                                                              \
    ...
    {                                                                                                              \
        struct PREFIX##_list_node *node = (struct PREFIX##_list_node *)kmalloc(sizeof(struct PREFIX##_list_node)); \
        node->val = val;                                                                                           \
        node->prev = KERNEL_NULL;                                                                                  \
        node->next = KERNEL_NULL;                                                                                  \
        return node;                                                                                               \
    }                                                                                                              \
                                                                                                                   \
